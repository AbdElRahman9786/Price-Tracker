...
const firecrawl = new Firecrawl({ apiKey: process.env.NEXT_PUBLIC_FIRE_CRWAL_API_KEY });

export const scarpelWebsite = async (url) => {
     try {
    ...
    // Firecrawl v2 returns data in result.json
